    ...
    <div className="h-full bg-gradient-to-b from-amber-50 via-orange-50 to-rose-50 overflow-y-auto">
      <div className="px-6 py-6">
        ...
        <div className="text-center mb-5">
          <h1 className="text-3xl mb-1 text-amber-700">
            Story Time
          </h1>
        ...
        <div className="bg-gradient-to-br from-white to-orange-50 rounded-3xl shadow-xl p-6 mb-4 border-2 border-orange-200">
          <div className="mb-6">
            ...
            <div className="text-center mb-4">
              <h2 className="text-2xl mb-1 text-gray-800">
                The Summer Garden Adventure
              </h2>
              <p className="text-sm text-gray-500">
                Told by {isGrandparent ? "You" : "Grandparents"}
              </p>
            </div>
        ...
        <div className="bg-gradient-to-br from-white to-sky-50 rounded-3xl shadow-lg p-6 mb-4 border-2 border-sky-200">
          ...
          <p className="text-sm text-gray-700 leading-relaxed mb-4">
            Remember that wonderful summer we spent together? Deep in the garden, we discovered a hidden bird's nest.
            From that day on, we visited those little birds every day, watching them grow day by day. It was a magical time
            filled with discovery and wonder, helping us appreciate the beauty of nature and the miracle of life.
          </p>
          <div className="bg-sky-50 rounded-xl p-3 mb-4 border border-sky-100">
            <p className="text-xs text-gray-600 mb-2">
              {isGrandparent
                ? "💭 Key Points: Emphasize patience in observation, the preciousness of life, and the warmth of companionship"
                : "💭 Listening Focus: Feel the beauty of nature and learn patience and care from grandparents"}
            </p>
            {isGrandparent && (
              <p className="text-xs text-amber-700">
                Tip: Speak slowly and add details to help children feel immersed in the story
              </p>
            )}
          </div>
        ...
        <div className="bg-gradient-to-r from-purple-100 to-fuchsia-100 rounded-2xl p-4 border-2 border-purple-200">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500">
              Stories create bonds that last forever
            </p>
          </div>
        </div>
      </div>
